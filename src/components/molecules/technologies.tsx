...
export default function Technologies({techs}: TechnologiesProps) {
  return (
    <div className="flex flex-wrap my-3 justify-center">
      {techs.map((tech) => (
        <div key={tech.id} className="flex flex-col rounded-xl mx-4 my-2 p-2 duration-700 cursor-pointer items-center justify-center shadow-xl hover:shadow-gray-800">
